    ...
    $scope.event_db_container = [
      ...
      {card_title:"LOTOS", card_body: "THE TRUNK SHOW", card_since: "2015.11", card_where: "Korea",
       ...
       img_container: [{img:'https://s3-ap-northeast-1.amazonaws.com/papyrus.eyewear/16/01.png'},
		       ...
		       {img:'https://s3-ap-northeast-1.amazonaws.com/papyrus.eyewear/16/04.png'}]},
      ...
      // #12
      {card_title:"Papyrus Event", card_body: "THE RENOVATION", card_since: "2015.07", card_where: "Korea",
      ...
      // #11
      {card_title:"Dior", card_body: "THE TRUNK SHOW", card_since: "2015.06", card_where: "Korea",
      ...
      // #7
      {card_title:"Max Pittion", card_body: "THE LAUNCH EVENT", card_since: "2014.05", card_where: "Korea",
      ...
      // #5
      {card_title:"Dior Homme", card_body: "THE TRUNK SHOW", card_since: "2013.04", card_where: "Korea",
